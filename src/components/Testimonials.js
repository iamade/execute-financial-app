    ...
    <div className='testimonials' id='testimonials'>
        ...
        <div className='content'>
            <div className='card'>
                ...
                <p>It is not every day that you come across a passionate and trustworthy financial adivsor.john doe is true professional who does his work really well. Thanks John!</p>
